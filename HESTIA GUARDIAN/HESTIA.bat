...
if "%escolha%"=="7" goto :sair_standby
if "%escolha%"=="8" goto :exit
...
echo.^| Dicas: Desligue os aparelhos eletrônicos quando não estiverem em uso.                                            ^|
echo.^|        Economize água.                                                                                           ^|
echo.^|        Reduza, Reutilize, Recicle.                                                                               ^|
echo.^|        Plante árvores e adote práticas sustentáveis.                                                             ^|
echo.^|                                                                                                                  ^|
echo.^| O sistema está em modo Standby.                                                                                  ^|
