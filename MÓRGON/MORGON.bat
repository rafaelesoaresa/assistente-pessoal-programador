...
set /p num_tables=Digite o numero de tabelas a serem criadas: 

:: Crie o arquivo SQL com base nas informacoes inseridas
...
for /l %%i in (1, 1, %num_tables%) do (
    ...
    set /p num_columns=Digite o numero de colunas para a tabela !table_name!: 

    :: Inicie a declaracao CREATE TABLE
    ...
    :: Complete a declaracao CREATE TABLE
